...
- Dark background with bright text (terminal color scheme, focused on
  cyan, magenta and lighter pastels for ease of reading)
- Monospace typography throughout
- Some text that types out character by character
- Scrolling output like a CLI tool when menu items or links are clicked
...
Some pages such as Experience & Projects and Useful Sites should be stored in MarkDown files for easy
human editing. These files should be able to be processed into the deployable
...
### Color Palette
Based on dogrun vim theme in file dogrun.vim

Mix of terminal/cyberpunk colors:
- **Primary backgrounds:** Very dark grays/black
- **Primary text:** Bright terminal white
- **Accent colors:** Neon cyan, neon magenta
...
#### 4. Useful Sites
Content imported from website_index.md
...
- Commodore Amiga, Apple II aesthetics
- Female hacker/developer
...
- Perl, C, Ruby, JavaScript/TypeScript
...
The final result should feel like using a real terminal emulator, while remaining professional and accessible to all users. It should be clean, clear and make understanding the interface easy for new users.
